...
namespace DinarInvestments.Infrastructure.Migrations
{
    ...
    [Migration("20250714224134_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DinarInvestments.Domain.Models.InvestmentOpportunity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreationDate = new DateTime(2025, 7, 14, 22, 41, 33, 447, DateTimeKind.Utc).AddTicks(7300),
                        ...
                        {
                            Id = 2,
                            CreationDate = new DateTime(2025, 7, 14, 22, 41, 33, 447, DateTimeKind.Utc).AddTicks(8160),
            ...
            modelBuilder.Entity("DinarInvestments.Domain.Models.Transaction", b =>
                {
                    b.HasOne("DinarInvestments.Domain.Models.Wallet", "FromWallet")
                        .WithMany()
                    ...
                    b.HasOne("DinarInvestments.Domain.Models.Wallet", "ToWallet")
                        .WithMany()
